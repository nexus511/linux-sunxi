...
struct vmmdev_request_header {
	...
	enum vmmdev_request_type requestType;
	/** OUT: Return code. */
	s32 rc;
 ...
 *
 * VBGL uses this to detect the precense of new features in the interface.
 */
...
#define VBOXOSTYPE_Linux26	0x53000
#define VBOXOSTYPE_x64		BIT(8)
...
#define VBOX_HGCM_REQ_DONE      BIT(0)
#define VBOX_HGCM_REQ_CANCELLED BIT(1)
